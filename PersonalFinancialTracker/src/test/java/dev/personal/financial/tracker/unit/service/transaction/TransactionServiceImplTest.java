//package dev.personal.financial.tracker.unit.service.transaction;
//
...
//                        transaction.getCategory().equals(TransactionCategory.FOOD) &&
...
//                true
//        );
//        when(transactionRepository.findByUserIdAndCategory(USER_ID, category.toString())).thenReturn(Collections.singletonList(transaction));
//
//        List<TransactionOut> result = transactionService.getTransactionsByUserIdAndCategory(USER_ID, category.toString());
//
//        assertThat(result).hasSize(1);
//        assertThat(result.get(0).getCategory()).isEqualTo(category);
//        verify(transactionRepository, times(1)).findByUserIdAndCategory(USER_ID, category.toString());
//    }
//
//    @Test
